  ...
  return (
    <div className="space-y-6 md:space-y-8 pb-10">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-2">
        <div>
          <h1 className="text-2xl md:text-3xl font-black text-blue-950 uppercase tracking-tighter">Command Center</h1>
          <p className="text-slate-500 text-xs md:text-sm font-medium">Monitoring operations and asset utilization.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-6">
        ...
        <KpiCard icon={Briefcase} title="Active Agremts" value={activeCount.toString()} subtext="Live Sessions" colorClass="bg-blue-50 text-blue-900 border-blue-100" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8">
        <div className="bg-white p-4 md:p-8 rounded-2xl shadow-sm border border-slate-200">
          <h3 className="text-[10px] md:text-xs font-black text-blue-950 uppercase tracking-widest mb-6 md:mb-8">Revenue Flow vs Expense (₹)</h3>
        ...
        <div className="bg-white p-4 md:p-8 rounded-2xl shadow-sm border border-slate-200">
          <h3 className="text-[10px] md:text-xs font-black text-blue-950 uppercase tracking-widest mb-6 md:mb-8 text-center">Equipment Demand Index</h3>
          <div className="h-60 md:h-80 w-full">
            <ResponsiveContainer width="100%" height="100%">
